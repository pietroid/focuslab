          ...
          children: [
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    if (emptyStateToday)
                      Text(
                        'Nada planejado, clique para organizar',
                    ...
                    if (!emptyStateToday) ...[
                      ...
                      DefaultCard(
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text('Preparar para dormir'),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text('Codando focuslab'),
                          AddButton(),
                        ],
                      ),
                      const SizedBox(height: AppSpacing.small),
                      const ProgressBar(progress: 65, maxValue: 100),
                      const SizedBox(height: AppSpacing.small),
                      const Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
            ...
            Align(
              ...
              child: GestureDetector(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Text('Time constrained now task'),
                          ],
                        ),
                        Row(
                          children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Text('Currently playing task'),
                          ],
                        ),
                      ],
                    ),
                ...
                child:
                    Icon(Icons.settings, color: Colors.white.withOpacity(0.1)),
              ),
            ),
            Align(
